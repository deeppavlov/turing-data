...
assert len(users_bot_flags) == len(users_bot_fact_labels) // 2 == len(users_bot_predicted_probs) // 2

print(sys.argv[1], ": ", spearmanr(users_bot_fact_labels, users_bot_predicted_probs).correlation)
